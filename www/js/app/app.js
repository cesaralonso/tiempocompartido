            ...
            function ($stateProvider, $urlRouterProvider) {
                ...
                $stateProvider
                    ...
                    .state('front.faqs', {
                        ...
                        controller: ['$scope', function($scope){
                            $scope.app.settings.htmlClass = 'hide-sidebar top-navbar ls-bottom-footer-fixed';
														$scope.app.settings.title = "faqs!!";
                        }]
                    })
                    .state('front.comprar-tiempos-compartidos', {
                        url: '/comprar-tiempos-compartidos',
                        templateUrl: 'front/comprar-tiempos-compartidos.html',
                        controller: ['$scope', function($scope){
                            $scope.app.settings.htmlClass = 'hide-sidebar top-navbar ls-bottom-footer-fixed';
														$scope.app.settings.title = "comprar!!";
                        }]
                    })
                    .state('front.alquilar-tiempos-compartidos', {
                        url: '/alquilar-tiempos-compartidos',
                        templateUrl: 'front/alquilar-tiempos-compartidos.html',
                        controller: ['$scope', function($scope){
                            $scope.app.settings.htmlClass = 'hide-sidebar top-navbar ls-bottom-footer-fixed';
														$scope.app.settings.title = "alquilar!!";	
                        }]
                    })
                    .state('front.condiciones-de-uso', {
                        url: '/condiciones-de-uso',
                        templateUrl: 'front/condiciones-de-uso.html',
                        controller: ['$scope', function($scope){
                            $scope.app.settings.htmlClass = 'hide-sidebar top-navbar ls-bottom-footer-fixed';
														$scope.app.settings.title = "condiciones-de-uso!!";
                        }]
                    })
                    .state('front.politicas-de-privacidad', {
                        url: '/politicas-de-privacidad',
                        templateUrl: 'front/politicas-de-privacidad.html',
                        controller: ['$scope', function($scope){
                            $scope.app.settings.htmlClass = 'hide-sidebar top-navbar ls-bottom-footer-fixed';
														$scope.app.settings.title = "politicas-de-privacidad!!";
                        }]
                    })
                    .state('front.quienes-somos', {
                        url: '/quienes-somos',
                    ...
                    .state('front.contacto', {
                        url: '/contacto',
                        templateUrl: 'front/contacto.html',
                        controller: ['$scope', function($scope){
                            $scope.app.settings.htmlClass = 'hide-sidebar top-navbar ls-bottom-footer-fixed';
														$scope.app.settings.title = "contacto!!";
                        }]
                    })
                    ...
                    .state('front.property', {
                        ...
                        controller: ['$scope', function($scope){
                            $scope.app.settings.htmlClass = 'hide-sidebar top-navbar ls-bottom-footer-fixed';
                            $scope.app.settings.title = 'Titulo propiedades';
                        }]
                    });
            }
        ]
